...
// Winter Genocide Buddy Killer-49
/obj/item/gun/ballistic/automatic/remis/winter
	...
	fire_sound = 'modular_septic/sound/weapons/guns/rifle/buddykiller.wav'
	suppressed_sound = 'modular_septic/sound/weapons/guns/rifle/buddykiller_silenced.wav'
