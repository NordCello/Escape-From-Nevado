...
/datum/bartering_recipe/helmet/ultraheavy
	outputs = list(
...
/datum/bartering_recipe/vest/ultra
	outputs = list(
...
/datum/bartering_recipe/helmet/m56
	outputs = list(
...
/datum/bartering_recipe/idobe
	outputs = list(
		/obj/item/clothing/mask/gas/idobe = 1,
	)
	inputs = list(
