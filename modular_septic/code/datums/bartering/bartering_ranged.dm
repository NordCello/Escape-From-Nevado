...
/datum/bartering_recipe/batata
	outputs = list(
		...
		/obj/item/ammo_casing/l40mm = 1,
		/obj/item/ammo_casing/l40mm/inc = 1,
		/obj/item/ammo_casing/l40mm/smoke = 1,
		/obj/item/ammo_casing/l40mm/gas = 1,
	)
	inputs = list(
...
/datum/bartering_recipe/svd
	outputs = list(
		...
		/obj/item/ammo_box/magazine/a762svd = 2,
	)
	inputs = list(
