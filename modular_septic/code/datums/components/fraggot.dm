...
/datum/component/fraggot/RegisterWithParent()
	...
	buddylay = our_fraggot.overlay_fullscreen("buddy", /atom/movable/screen/fullscreen/buddy)
...
/datum/component/fraggot/process(delta_time)
	...
	if(our_fraggot.client)
		...
		var/static/list/fraggot_sounds = list(
			...
			'modular_septic/sound/memeshit/buddy.ogg',
			'modular_septic/sound/memeshit/buddies.ogg',
			'modular_septic/sound/memeshit/buddy_alarm.ogg',
